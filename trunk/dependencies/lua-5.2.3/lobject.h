...
/* "vector2" "(A," " B)" */
#define LUAI_MAXVECTOR22STR (7 + 2*(1+LUAI_MAXFLOAT2STR+1))
...
int lua_vector42str (char *s, lua_Float4 n);
lua_Float4 lua_str2vector4 (char *s, char *p);
...
#define ttisvector4(o)	(ttype(o) == LUA_TVECTOR4)
...
#define v4value(o)  check_exp(ttisvector4(o), val_(o).f4)
#define v3value(o)  check_exp(ttisvector3(o), val_(o).f4)
#define v2value(o)  check_exp(ttisvector2(o), val_(o).f4)
#define qvalue(o)  check_exp(ttisquat(o), val_(o).f4)
...
#define setv4value(obj,x) \
  { TValue *i_o=(obj); val_(i_o).f4=(x); i_o->tt_=LUA_TVECTOR4; }

#define setv3value(obj,x) \
  { TValue *i_o=(obj); val_(i_o).f4=(x); i_o->tt_=LUA_TVECTOR3; }

#define setv2value(obj,x) \
  { TValue *i_o=(obj); val_(i_o).f4=(x); i_o->tt_=LUA_TVECTOR2; }

#define setqvalue(obj,x) \
  { TValue *i_o=(obj); val_(i_o).f4=(x); i_o->tt_=LUA_TQUAT; }
